...
<body id="top" data-spy="scroll" data-target=".navbar" data-offset="60" onload="getAPI()">
    <div class="wrapper nav-mobile" id="wc">
        <nav class="navbar navbar-expand-lg navbar-dark nav_style p-0">
            ...
            <div class="collapse navbar-collapse justify-content-around" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link px-4" href="#wc">World Tracker</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-4" href="ccorona.php">India Tracker</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-4" href="NewsArticlesComponent.php">Videos/Articles</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="corona_update container-fluid">
            <div class="mb-3 mt-5 up">
                <h3 class="text-center">WORLD COVID-19 LIVE UPDATES</h3>
            </div>
        ...
        function getAPI() {
            ...
            $.get('https://api.coronatracker.com/v3/stats/worldometer/country',function(data){
                ...
                for (var index = 1; index <= data.length; index++) {
                    ...
                    x.insertCell(1);
                    tbval.rows[index].cells[1].innerHTML = data[index-1]['countryCode'];
                    tbval.rows[index].cells[1].style.background = '#7a4a71';
                    tbval.rows[index].cells[1].style.color = 'white';

                    x.insertCell(2);
                    tbval.rows[index].cells[2].innerHTML = data[index-1]['totalConfirmed'];
